...
useEffect(() => {
console.log('useEffect de click');
document.title = `${clicks} veces`;
return () => {
// se ejecuta al destruir el componente console.log('el componente se va a destruir')
}
}, [clicks])
...
useEffect(() => {
    ...
    const intervalId = setInterval(() => { setFecha (new Date()) }, 1000)
